...
class RerankerConfig:
    ...
    def from_env(cls) -> "RerankerConfig":
        ...
        return cls(
            ...
            enable_distributed=os.environ.get("RERANKER_DISTRIBUTED", "false").lower() == "true",
            worker_timeout=float(os.environ.get("RERANKER_WORKER_TIMEOUT", "300.0")),
            max_retries=int(os.environ.get("RERANKER_MAX_RETRIES", "2")),
